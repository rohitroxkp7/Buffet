...
parser.add_argument("--nCycles", type=int, default=50, help="Set the number of file cycles done for fine grid [default: %(default)s]")
parser.add_argument("--fineCFL", type=float, default=10.5, help="Set the CFL number for fine mesh [default: %(default)s]")
parser.add_argument("--coarseCFL", type=float, default=10.3, help="Set the CFL number for the coarse mesh [default: %(default)s]")
parser.add_argument("--turbModel", choices=["SA"], default="SA", help="[default: %(default)s]")
parser.add_argument("--discretization", choices=["central plus scalar dissipation", "central plus matrix dissipation", "upwind"], default="central plus matrix dissipation", help="[default: %(default)s]")
...
parser.add_argument("--mach", type=float, default=0.73, help="[default: %(default)s]")
parser.add_argument("--alpha", type=float, default=4.0, help="[default: %(default)s]")
...
files["gridFile"] = f"./INPUT/mesh/OAT15A_{args.geometry}_{args.gridFamily}_{args.gridLevel}.cgns"
